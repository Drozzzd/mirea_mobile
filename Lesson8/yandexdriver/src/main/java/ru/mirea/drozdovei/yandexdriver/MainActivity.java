package ru.mirea.drozdovei.yandexdriver;
...
import ru.mirea.drozdovei.yandexdriver.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener,
    ...
    private final Point ROUTE_END_LOCATION = new Point(55.758610, 37.645357);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isWork) {
            ...
            final Point userLoc = new Point(55.663685, 37.466925);
            submitRequest(userLoc);

            PlacemarkMapObject marker = mapView.getMap().getMapObjects().addPlacemark(new
                            Point(55.758610, 37.645357),
                    ImageProvider.fromResource(this, R.drawable.place_icon));

            marker.addTapListener(new MapObjectTapListener() {
                @Override
                public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point point) {
                    Log.d(TAG, "Маркер был нажат.");
                    Toast.makeText(getApplication(), "Крафтовый бар: Дом в Котором", Toast.LENGTH_SHORT).show();
                    return false;
                }
            });
        } else {
