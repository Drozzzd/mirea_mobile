package ru.mirea.drozdovei.httpurlconnection;
...
import ru.mirea.drozdovei.httpurlconnection.databinding.ActivityMainBinding;
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                if(responseJson.has("current_weather")) {
                    ...
                    binding.textViewPostalCode.setText("Postal Code: " + postal);
